            ...
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?= BASE_URL?>/admin_kelas/edit/<?= $kelas['id_kelas']?>" class="btn btn-warning">Edit</a>
                            <a href="<?= BASE_URL?>/admin_kelas/destroy/<?= $kelas['id_kelas']?>" class="btn btn-danger">Hapus</a>
                        </td>
                    </tr>
                    <?php endforeach;?>
                </tbody>
