...
<div>
    <div class="mb-2 d-flex justify-content-between">
        ...
        <a href="<?= BASE_URL?>/admin_transaksi/history/<?= $id_siswa?>" class="btn btn-secondary">History</a>
    </div>
    ...
    <div class="p-3 row">
        <?php foreach ($data['select_month'] as $month):?>
            <form class="col-3" action="<?= BASE_URL?>/admin_transaksi/store/<?= $tahun_ajaran?>/<?= $month['month_num']?>/<?= $id_siswa?>/<?= $id_pembayaran?>" method="post">
